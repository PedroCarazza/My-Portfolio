          ...
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Disponível para uma conversa, sinta-se à vontade para me mandar uma mensagem.
                </Text>
                <Text
                  as="a"
                  color="grey2"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Mande um email com feedback, sugestões ou ideias
                </Text>
                ...
                <Text
                  ...
                  onClick={() =>
                    (window.location.href = "mailto:pedro_carazza@hotmail.com")
                  }
                >
                  Mande um email
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Podemos criar interações mais constantes, como também compartilhar contatos
